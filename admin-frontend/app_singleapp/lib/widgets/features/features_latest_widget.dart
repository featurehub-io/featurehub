...
class LatestFeaturesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EnvironmentFeaturesResult>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData &&
              snapshot.data.featureValues.isNotEmpty) {
            return Column(
              children: <Widget>[
                Container(
    ...
    _rows.add(TableRow(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text("Feature", style: Theme.of(context).textTheme.subtitle2),
          ),
    ...
    return TableRow(
        ...
        children: <Widget>[
          Container(
              ...
              child: findFeature == null ? SizedBox.shrink() : FHLinkWidget(
                  href:
          ...
          Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(_findApplication(fv, featuresList) != null ? _findApplication(fv, featuresList).name : ''),
                  Text(_findPortfolio(fv, featuresList, bloc) != null ? _findPortfolio(fv, featuresList, bloc).name : '',
                      style: Theme.of(context).textTheme.caption),
                ],
              )),
          Text(_findEnvironment(fv, featuresList) != null ? _findEnvironment(fv, featuresList).name : '',
  ...
  Feature _findFeature(
    ...
    return featuresList.features.firstWhere((feature) => feature.key == fv.key, orElse: () => null);
  }
