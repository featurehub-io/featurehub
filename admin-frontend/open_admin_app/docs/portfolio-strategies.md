...
- internationalisation must be followed and english and chinese translations must be provided. The original translations must be stored in admin-frontend/open_admin_app/lib/l10n/app_zh.arb and admin-frontend/open_admin_app/lib/l10n/app_en.arb
