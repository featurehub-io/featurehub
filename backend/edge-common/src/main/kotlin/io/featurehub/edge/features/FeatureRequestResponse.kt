 ...
 */
class FeatureRequestResponse(val environment: FeatureEnvironmentCollection, val success: FeatureRequestSuccess, val key: KeyParts, val etag: String, val envInfo: Map<String, String>?)
