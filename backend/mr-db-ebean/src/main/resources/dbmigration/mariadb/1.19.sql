-- apply alter tables
alter table fh_service_account add column fk_changed_by varchar(40) not null default '00000000-0000-0000-0000-000000000000';
update fh_service_account set fk_changed_by = fk_person_who_created;
alter table fh_service_account add column fk_sdk_person varchar(40) not null default '00000000-0000-0000-0000-000000000000';
