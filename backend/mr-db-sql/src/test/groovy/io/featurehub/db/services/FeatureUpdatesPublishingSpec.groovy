...
class FeatureUpdatesPublishingSpec extends Base2Spec {
  ...
  def setup() {
    ...
    ThreadLocalConfigurationSource.createContext(
      ['auditing.enable': 'true','messaging.publisher.thread-pool': "1"])
    ...
    featureSqlApi = new FeatureSqlApi(convertUtils, rsv, Mock(CacheSourceFeatureGroupApi), updateFeatureApi)
