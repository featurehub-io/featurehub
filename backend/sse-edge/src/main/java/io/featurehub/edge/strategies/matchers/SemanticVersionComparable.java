...
// This is the ComparableVersion class from Maven
...
public class SemanticVersionComparable implements Comparable<SemanticVersionComparable> {
  ...
  public SemanticVersionComparable(String version) {
  ...
  @Override
  public int compareTo(SemanticVersionComparable o) {
  ...
  @Override
  public boolean equals(Object o) {
    return (o instanceof SemanticVersionComparable) && items.equals(((SemanticVersionComparable) o).items);
  }
  ...
  public static void main(String... args) {
    ...
    SemanticVersionComparable prev = null;
    int i = 1;
    for (String version : args) {
      SemanticVersionComparable c = new SemanticVersionComparable(version);
