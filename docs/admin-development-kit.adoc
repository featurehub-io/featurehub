...
== Overview
The Admin SDK is designed to provide access to the Management Repository API. It is an OpenAPI driven API, there is no functionality in the API that is not documented in our published OpenAPI.
