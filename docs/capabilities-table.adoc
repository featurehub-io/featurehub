...
|Analytics Support|Y|Y|Y|Y|N
|Google Analytics|Y|Y|Y|N|N
|===================================
...
|Feature Interceptors|Y|Y|N|N|N
|===================================
...
- *(4)* C# and .NET is supported by libraries from nuget. https://www.nuget.org/packages/FeatureHub.SDK/1.0.0[Nuget.org]
