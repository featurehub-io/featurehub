...
Once you have done this, you can then simply run the example project, so you don't have to create sample app and add SDK code yourself. Example project consist of a back-end service and a front-end sample app with some sample features already in place.
