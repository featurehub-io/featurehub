...
This will kick off the example React app that can be accessed on port 5000. It will also start the "back-end" Node server that runs inside the container on 8099. Experiment with the sample app - add a few todo's using "lower case".
