...
`curl https://github.com/featurehub-io/featurehub-install/archive/release-1.1.2.tar.gz -o featurehub.tar.gz | tar -xvz`
...
`cd featurehub-install-release-1.1.2/docker-compose-options/all-in-one-h2`

`docker-compose up`

For Postgres option:

`cd featurehub-install-release-1.1.2/docker-compose-options/all-in-one-postgres`
...
`cd featurehub-install-release-1.1.2/docker-compose-options/all-separate-postgres`
