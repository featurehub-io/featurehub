...
`curl https://github.com/featurehub-io/featurehub-install/archive/release-1.1.1.tar.gz -o featurehub.tar.gz`
...
`cd featurehub-install-release-1.1.1/docker-compose-options/all-in-one-h2`

`docker-compose up`

For Postgres option:

`cd featurehub-install-release-1.1.1/docker-compose-options/all-in-one-postgres`
...
`cd featurehub-install-release-1.1.1/docker-compose-options/all-separate-postgres`
