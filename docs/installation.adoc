...
`curl https://github.com/featurehub-io/featurehub-install/archive/release-0.0.7.tar.gz -o featurehub.tar.gz`
...
`cd featurehub-install-release-0.0.7/docker-compose-options/all-in-one-h2`

`docker-compose up`

For Postgres option:

`cd featurehub-install-release-0.0.7/docker-compose-options/all-in-one-postgres`
...
`cd featurehub-install-release-0.0.7/docker-compose-options/all-separate-postgres`
