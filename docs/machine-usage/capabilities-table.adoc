...
|Local Yaml Interceptor|Y|N|N|N|N|N|N|N
|Alternative Storage Support^5^|Y|N|N|N|N|N|N|N
|Local Yaml Storage|Y|N|N|N|N|N|N|N
|Redis Storage|N|N|N|N|N|N|N|N
|Browser Session Storage|N|N|N|N|N|N|N|N
|===================================
