...
to transfer messages about environments, features and service accounts to feed Dacha and Edge. Kafka and Google Pub/Sub are alternatives.
...
- it supports multiple async layers (NATS, Google Pub/Sub, Kafka)
