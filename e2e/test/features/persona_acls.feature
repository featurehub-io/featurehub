...
#    add user to the group with permissions restricted for some envs.
  ...
  Scenario Outline: Create apps and setup different access, e.g read, lock..
    ...
    And I cannot set the boolean feature value as "true" for environment "<envName>" for feature "<featureKey>"
    And I cannot set the boolean feature value as "false" for environment "<envName2>" for feature "<featureKey>"
    And I cannot set the boolean feature value as "false" for environment "<envName3>" for feature "<featureKey>"
    And I cannot set the boolean feature value as "true" for environment "<envName4>" for feature "<featureKey>"
    And I unlock the feature value for environment "<envName>" for feature "<featureKey>"
    And I unlock the feature value for environment "<envName2>" for feature "<featureKey>"
    And I unlock the feature value for environment "<envName3>" for feature "<featureKey>"
    And I unlock the feature value for environment "<envName4>" for feature "<featureKey>"
    And I set the boolean feature value as "true" for environment "<envName>" for feature "<featureKey>"
    And I set the boolean feature value as "false" for environment "<envName2>" for feature "<featureKey>"
