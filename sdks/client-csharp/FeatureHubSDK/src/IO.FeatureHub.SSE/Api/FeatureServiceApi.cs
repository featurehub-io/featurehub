...
namespace IO.FeatureHub.SSE.Api
{
    ...
    public interface IFeatureServiceApiSync : IApiAccessor
    {
        ...
        object SetFeatureState (string sdkUrl, string featureKey, FeatureStateUpdate featureStateUpdate = default(FeatureStateUpdate));
        ...
        ApiResponse<object> SetFeatureStateWithHttpInfo (string sdkUrl, string featureKey, FeatureStateUpdate featureStateUpdate = default(FeatureStateUpdate));
    ...
    public interface IFeatureServiceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<object> SetFeatureStateAsync (string sdkUrl, string featureKey, FeatureStateUpdate featureStateUpdate = default(FeatureStateUpdate));
        ...
        System.Threading.Tasks.Task<ApiResponse<object>> SetFeatureStateAsyncWithHttpInfo (string sdkUrl, string featureKey, FeatureStateUpdate featureStateUpdate = default(FeatureStateUpdate));
    ...
    public partial class FeatureServiceApi : IFeatureServiceApi
    {
        ...
        /// <param name="featureStateUpdate"> (optional)</param>
        /// <returns>object</returns>
        public object SetFeatureState (string sdkUrl, string featureKey, FeatureStateUpdate featureStateUpdate = default(FeatureStateUpdate))
        {
        ...
        /// <param name="featureStateUpdate"> (optional)</param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> SetFeatureStateAsync (string sdkUrl, string featureKey, FeatureStateUpdate featureStateUpdate = default(FeatureStateUpdate))
        {
        ...
        /// <param name="featureStateUpdate"> (optional)</param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<IO.FeatureHub.SSE.Client.ApiResponse<object>> SetFeatureStateAsyncWithHttpInfo (string sdkUrl, string featureKey, FeatureStateUpdate featureStateUpdate = default(FeatureStateUpdate))
        {
            // verify the required parameter 'sdkUrl' is set
            if (sdkUrl == null)
                throw new IO.FeatureHub.SSE.Client.ApiException(400, "Missing required parameter 'sdkUrl' when calling FeatureServiceApi->SetFeatureState");
